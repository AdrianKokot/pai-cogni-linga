...
class HomeController extends Controller {
  public function main() {
      return $this->view('main.php', ['pageTitle' => 'Strona główna', 'web' => [
          ...
          'historySets' => DB::select("SELECT id, title, flashcard_count FROM learning_history as fh join study_set as ss on fh.study_set = ss.id WHERE visibility = 1 and user = :id order by finished_date DESC LIMIT 3", ["id" => $_SESSION["userId"]])["data"]
      ]]);
  }
