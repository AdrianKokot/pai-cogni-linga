          ...
          <form method="post" id="create-study-set-form">
            ...
            <section>
              ...
              <section id="new-flashcards" class="c-40">
                <?php
                  $arrFlash = Session::old("flashcards") ?? null;
                  $count = $arrFlash ? count($arrFlash) : 0;
                  $i = 0;
                ...
                ?>
                  <div class="new-flashcard">
                    ...
                    <input type="hidden" name="new-flashcard-id[]" value="<?= $flash["id"] ?? ""?>">
                    <input type="text" name="new-flashcard-term[]" placeholder="pojęcie" value="<?= $flash["term"] ?>">
                    <input type="text" name="new-flashcard-definition[]" placeholder="definicja" value="<?= $flash["definition"] ?>">
                  </div>
                <?php } ?>
              </section>
